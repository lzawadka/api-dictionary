...
using api_dictionary.Infrastructure.Files;
using api_dictionary.Infrastructure.Identity;
using api_dictionary.Infrastructure.Persistence;
using api_dictionary.Infrastructure.Services;
using api_dictionary.Infrastructure.Services.Handlers;
...
namespace api_dictionary.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)//, IWebHostEnvironment environment)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("api_dictionaryDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
